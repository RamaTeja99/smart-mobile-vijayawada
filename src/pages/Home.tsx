...
import { ArrowRight, Star, Smartphone, Shield, Truck, Headphones } from "lucide-react";
...
const Home = () => {
  ...
  const features = [
    ...
    { icon: Truck, title: "Fast Delivery", description: "Quick and secure delivery to your doorstep" },
    { icon: Headphones, title: "Expert Support", description: "Professional guidance and after-sales support" }
  ];
      ...
      <section className="container mx-auto px-4">
        ...
        {featuredLoading ? (
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {featuredProducts.map((product) => (
              <Card key={product.id} className="group hover:shadow-elevated transition-all duration-300 cursor-pointer">
                <CardHeader className="space-y-4">
                  <div className="relative">
                    {product.is_bestseller && <Badge className="absolute top-2 left-2 z-10">Bestseller</Badge>}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="flex items-center">
                        ...
                        <span className="ml-1 text-sm font-medium">{product.average_rating?.toFixed(1) || "0.0"}</span>
                      </div>
        ...
        <div className="text-center mt-12">
          <Button variant="outline" size="lg" asChild>
            <Link to="/products">View All Products <ArrowRight className="ml-2 h-5 w-5" /></Link>
          </Button>
        </div>
      </section>
      ...
      <section className="bg-muted/30 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              We're committed to providing exceptional service and the best mobile technology experience
            </p>
          </div>
